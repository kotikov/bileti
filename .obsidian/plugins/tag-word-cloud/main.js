...
var require_wordcloud2 = __commonJS({
  "node_modules/wordcloud/src/wordcloud2.js"(exports, module2) {
    ...
    (function(global) {
      ...
      var timer = {};
      var WordCloud2 = function WordCloud3(elements, options) {
        if (!isSupported) {
          return;
        }
      ...
      WordCloud2.isSupported = isSupported;
      WordCloud2.minFontSize = minFontSize;
      WordCloud2.stop = function stop() {
        if (timer) {
      ...
      if (typeof define === "function" && define.amd) {
        global.WordCloud = WordCloud2;
        define("wordcloud", [], function() {
          return WordCloud2;
        });
      } else if (typeof module2 !== "undefined" && module2.exports) {
        module2.exports = WordCloud2;
      } else {
        global.WordCloud = WordCloud2;
      }
    })(exports);
...
var TagCloudPlugin2 = class extends import_obsidian4.Plugin {
  ...
  parseCodeblockOptions(source) {
    ...
    const previewBlock = getComputedStyle(document.querySelector(".markdown-preview-view.is-readable-line-width .markdown-preview-sizer"));
    if (previewBlock === void 0) {
      logger.error("Preview block is undefined");
      return void 0;
    }
    const max_width = document.querySelectorAll(".markdown-preview-view.is-readable-line-width .markdown-preview-sizer, .cm-content")[0].clientWidth;
  ...
  generateCloud(values, options, el, searchPrefix) {
    ...
    (0, import_wordcloud.default)(canvas, {
      list: tmp,
